...
\begin{enumerate}[A.]
    \item Established by \titleref{sec:const-7}, \titleref{ssec:const-7-4}, of the NCCYC Constitution to hear protests.
    \item A protest will first be reviewed by the District Chairperson or Vice Chairperson to determine if it was filed in accordance with \titleref{sec:const-7}, \titleref{ssec:const-7-1}, of the Constitution.  If a protest is filed, they will then contact the Official in Chief to determine that the protest is on a rule infraction and not on a judgment call.
...
\begin{enumerate}[A.]
    ...
    \item \textbf{Meeting:} 
    The time and location shall be determined by the monthly Executive Board Meeting rotation as identified in \titleref{sec:const-7}, \titleref{ssec:const-7-1}, of the Constitution.  A quorum of {\em four (4)} is required.
...
\begin{enumerate}[A.]
    \item Established by \titleref{sec:const-7}, \titleref{ssec:const-7-4} of the Constitution to hear disciplinary action appeals and protest appeals.
    \item An appeal will first be reviewed by the Chairperson or Vice Chairperson to determine if the appeal was filed in accordance with \titleref{sec:const-7}, \titleref{ssec:const-7-1} of the Constitution.
...
We will {\em attempt} to schedule around Girl/Boy scout events if they are listed.  We {\em will not reschedule} around Girl/Boy Scout events if they are not listed.  An exception will be any Archdiocesan Directive. One copy should be submitted with the Team Entry Forms.
...
\begin{enumerate}[A.]
    ...
    \item In the event of an ejection per \titleref{sec:bylaw-4}, the game official shall obtain the ejected person’s ID card and, as such, it becomes part of his/her report. It remains with the North County CYC Athletic Association until the suspension is resolved.
...
The Official in Chief (``OIC'') shall be nominated by an Athletic Association and must be approved by the District Chairperson.  His/her duties and term of office are covered in North County \titleref{sec:rules-g}, \titleref{ssec:rules-g-4}.
...
\begin{enumerate}[A.]
    ...
    \item If, after a warning, team conduct is not satisfactory after continuing, or attempting to continue the game, the official may suspend play.  Final determination of the game will be decided by the Chairperson following the guidelines covered in the By-Laws under \titleref{sec:bylaw-1}, \titleref{ssec:bylaw-1-1}.
\end{enumerate}
